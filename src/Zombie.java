 ...
 * Zombie extends the {@link Sprite} class.
 * <p>
 *
...
class Zombie extends Sprite implements GraphicsUpdater {
     ...
     *
     * @param x x-coordinate of a Zombie object.
     * @param y y-coordinate of a Zombie object.
     */
    Zombie(int x, int y) {
     ...
     * Update Position
     *
     * updates the position of the Zombie to chase the human.
